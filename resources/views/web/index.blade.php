...
<div id="content" class="site-content ">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="col-lg-5 col-md-12  col-sm-12 col-xs-12 image_column">
                                <div class="slider_image">
                                    <img src="assets/images/sliders/slider-2-1.png" class="img-fluid" alt="slider image">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="slide-item-content content_right">
                    ...
                    <div class="auto-container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5 col-md-12  col-sm-12 col-xs-12 image_column">
                                <div class="slider_image">
                                    <img src="assets/images/sliders/slider-2-2.png" class="img-fluid" alt="slider image">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="slide-item-content content_left">
                    ...
                    <div class="auto-container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5 col-md-12  col-sm-12 col-xs-12 image_column">
                                <div class="slider_image">
                                    <img src="assets/images/sliders/slider-2-3.png" class="img-fluid" alt="slider image">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                    <div class="service_box style_four dark_color">
                        <div class="service_content">
                            <div class="image_box">
                                <img src="assets/images/projects/project-6-img.jpg" class="img-fluid" alt="Service Image">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-12 mb-5 mb-lg-5 mb-xl-0">
                    <div class="image_boxes style_three">
                        <img src="assets/images/about/about-8.jpg" class="img-fluid height_500 object-fit-cover" alt="image">
                        <div class="video_box">
                    ...
                    <div class="service_box style_three dark_color">
                        <div class="service_content">
                            <div class="content_inner">
                                ...
                                <a href="#" class="read_more">Read more <i class="icon-right-arrow"></i></a>
                            </div>
                        </div>
                    </div>
                    <!--===============spacing==============-->
                        ...
                        <div class="s_tab_wrapper">
                            <div class="s_tabs_content">
                                ...
                                <div class="s_tab fade" id="tabtabthree">
                                    <div class="tab_content one" style="background-image:url(assets/images/about/about-4.jpg)">
                                        <div class="content_image">
                                            <h6>Why Creote</h6>
                                ...
                                <div class="s_tab fade" id="tabtabtfour">
                                    <div class="tab_content one" style="background-image:url(assets/images/about/about-2.jpg)">
                                        <div class="content_image">
                                            <h6>Why Creote</h6>
                                ...
                                <div class="s_tab fade" id="tabtabfive">
                                    <div class="tab_content one" style="background-image:url(assets/images/about/about-3.jpg)">
                                        <div class="content_image">
                                            <h6>Why Creote</h6>
    ...
    <!---tab-end--->
    <!---price-tab--->
    <section class="price-plan-tab-section">
        <!--===============spacing==============-->
        <div class="pd_top_80"></div>
        <!--===============spacing==============-->
        <div class="container">
                                        ...
                                        <div class="price_plan_box style_one ">
                                            <div class="inner_box">
                                                ...
                                                <div class="bottom">
                                                    ...
                                                    <a href="#" target="_blank" rel="nofollow" class="theme-btn two">Get Now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <section class="testimonial bg_op_1" style="background-image: url(assets/images/testimonialbg.jpg);">
        <div class="row align-items-center">
            <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-12 pd_zero">
                <div class="image">
                    <img src="assets/images/testi-image.jpg" class="simp_img img-fluid object-fit-cover height_560px" alt="image" />
                </div>
            </div>
            <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-12 pd_zero">
                <!--===============spacing==============-->
    ...
    <section class="blog-section">
        ...
        <div class="large-container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="blog_post_section  two_column news_wrapper_grid style_two ">
                        <div class="grid_show_case grid_layout clearfix">
                            <div class="grid_box _card">
                                <div class="news_box default_style list_view has_images">
                                    <div class="image img_hover-1">
                                        <img loading="lazy" width="750" height="420" src="assets/images/blog/blog-image-11.jpg" class="img-fluid" alt="img">
                                    ...
                                    <div class="content_box">
                                        ...
                                        <div class="source">
                                            ...
                                            <a href="blog-single.html" class="link__go">Read more</a>
                                        </div>
                            ...
                            <div class="grid_box _card">
                                <div class="news_box default_style list_view has_images">
                                    <div class="image img_hover-1">
                                        <img width="750" height="420" src="assets/images/blog/blog-image-3.jpg" class="img-fluid" alt="img">
                                        <a href="#" class="categories">
                                            <i class="icon-folder"></i>Employee Relations
                                        </a>
                                    </div>
                                    <div class="content_box">
                                        <div class="date">
                                        ...
                                        <div class="source">
                                            ...
                                            <a href="#" class="link__go">Read more</a>
                                        </div>
                                        <div class="auhtour_box">
                                            <img alt="img" src="assets/images/auth-2.png" height="60" width="60" class="img-fluid">
                                            <div class="contnet_a">
                                                <p>POSTED BY</p>
                                                <h4>
                                                    Evan Thomas
