...
<head>
    ...
    <link rel='stylesheet' href="{{ asset('/web/assets/css/style.css?v=3') }}" type='text/css' media='all' />
    <link rel='stylesheet' href="{{ asset('/web/assets/css/scss/elements/theme-css.css?v=3') }}" type='text/css' media='all' />
    ...
    <div id="page" class="page_wapper hfeed site">
        ...
        <div class="floating_menu_box">
            <ul class="float_menu_box">
                ...
                <li class="floating_menu_text {{ (request()->segment(1) == 'team') ? 'active' : '' }}">
